    ...
    <div className="landing-shell page-transition-in min-h-full">
      <header className="landing-header">
        <div className="mx-auto flex w-full max-w-[92rem] items-center justify-between px-6 py-5 sm:px-8">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brand text-sm font-semibold text-white">
              A
            </span>
            <span className="text-xl font-semibold text-ink">AutoBooker</span>
          </div>
      ...
      <main>
        <section className="mx-auto grid w-full max-w-[92rem] gap-14 px-6 py-16 sm:px-8 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="inline-flex items-center gap-1 rounded-full bg-brand-50/90 px-4 py-1.5 text-xs text-brand-700">
          ...
          <div className="surface-panel landing-showcase">
            <h2 className="text-xl font-semibold text-ink">项目示例</h2>
        ...
        <section className="py-14">
          <div className="mx-auto w-full max-w-[92rem] px-6 sm:px-8">
            <h2 className="text-3xl font-semibold text-ink">三步完成一本书</h2>
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
              {steps.map((step, index) => (
                <article key={step.title} className="surface-panel">
                  <p className="text-xs font-semibold uppercase tracking-wider text-brand-600">Step {index + 1}</p>
        ...
        <section className="mx-auto w-full max-w-[92rem] px-6 py-16 sm:px-8">
          <div className="surface-panel flex flex-col justify-between gap-5 md:flex-row md:items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-lg font-semibold text-ink">准备好创建你的下一本书了吗？</p>
